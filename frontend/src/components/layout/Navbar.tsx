...
import { Mic, Sparkles, Shield, Activity, ArrowRight } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 glass-panel border-b border-slate-800/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div 
          ...
          onClick={onNavigateLanding || onResetSession}
        >
        ...
        {/* Center Nav Links (Hidden during active interview studio) */}
        {!activeSession && (
        ...
        <div className="flex items-center gap-3">
          {activeSession ? (
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-medium">
              ...
              <span>Interview Session Live</span>
            </div>
          ) : (
            <button
