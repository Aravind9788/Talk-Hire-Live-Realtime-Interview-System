output "cloud_run_url" {
  description = "HTTPS URL of the deployed TalkHire Interview Coach Coach Cloud Run service"
...
output "lb_ip" {
  description = "Global static IP for the HTTPS Load Balancer — add this as an A record: TalkHire-sde-interview-agent → <lb_ip>"
